...
/**
 * Upgrade script for format_magistere_topics
 *
 * @param int $oldversion the version we are upgrading from
 * @return bool result
 */
function xmldb_format_magistere_topics_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2017020200) {
        ...
        upgrade_plugin_savepoint(true, 2017020200, 'format', 'magistere_topics');
    }
