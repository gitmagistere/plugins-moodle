@format @format_magistere_topics
Feature: Sections can be edited and deleted in magistere_topics format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete magistere_topics
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | magistere_topics | 0             | 5           |
  ...
  Scenario: View the default name of the general section in magistere_topics format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in magistere_topics format
    When I edit the section "0" and I fill the form with:
      | Custom | 1                     |
      | New value for Section name      | This is the general section |
    Then I should see "This is the general section" in the "li#section-0" "css_element"

  Scenario: View the default name of the second section in magistere_topics format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in magistere_topics format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "li#section-2" "css_element"

  Scenario: Edit section default name in magistere_topics format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  @javascript
  Scenario: Inline edit section name in magistere_topics format
  ...
  Scenario: Deleting the last section in magistere_topics format
  ...
  Scenario: Deleting the middle section in magistere_topics format
  ...
  @javascript
  Scenario: Adding sections in magistere_topics format
