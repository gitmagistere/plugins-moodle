...
/**
 * format_magistere_topics unit tests for upgradelib
 *
...
require_once($CFG->dirroot . '/course/format/magistere_topics/db/upgradelib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_magistere_topics_upgrade_testcase extends advanced_testcase {
    ...
    public function test_numsections_no_actions() {
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course->id, 'format' => 'magistere_topics',
    ...
    public function test_numsections_delete_empty() {
        ...
        $params1 = array('format' => 'magistere_topics', 'numsections' => 5, 'startdate' => 1445644800);
        $course1 = $this->getDataGenerator()->create_course($params1);
        $params2 = array('format' => 'magistere_topics', 'numsections' => 20, 'startdate' => 1445644800);
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course1->id, 'format' => 'magistere_topics',
    ...
    public function test_numsections_hide_non_empty() {
        ...
        format_magistere_topics_upgrade_remove_numsections();
    ...
    public function test_numsections_add_empty_sections() {
        ...
        $params = array('format' => 'magistere_topics', 'numsections' => 16, 'startdate' => 1445644800);
        $course = $this->getDataGenerator()->create_course($params);
